...
const post_to_main_site = async (path: string, cookie: string) => {
...
export const notify_site_invalidate_project_list_caches = (cookie: string) =>
  post_to_main_site('/api/cache/invalidate_project_list_caches', cookie);
...
export const notify_site_invalidate_project_map_cache = (cookie: string, project_id: number) =>
  post_to_main_site(`/api/cache/invalidate_project_map_cache/${project_id}`, cookie);
