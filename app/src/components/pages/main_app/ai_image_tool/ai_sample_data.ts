export const ai_sample_data = {
  ...
  sample_images: [
    new URL(
      '/src/components/pages/main_app/ai_image_tool/sample_ai_img/sample_image_1.webp',
      import.meta.url
    ).href,
    new URL(
      '/src/components/pages/main_app/ai_image_tool/sample_ai_img/sample_image_2.webp',
      import.meta.url
    ).href,
    new URL(
      '/src/components/pages/main_app/ai_image_tool/sample_ai_img/sample_image_3.webp',
      import.meta.url
    ).href,
    new URL(
      '/src/components/pages/main_app/ai_image_tool/sample_ai_img/sample_image_4.webp',
      import.meta.url
    ).href
  ]
};
